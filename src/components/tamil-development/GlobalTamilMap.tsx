      ...
      <div ref={containerRef} className="mt-8 flex flex-col items-center relative w-full">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 w-full mt-12 relative z-10">
          ...
          <div className="flex flex-col items-center justify-center p-4">
            <span className="font-display font-medium text-white text-lg">{locale === 'ta' ? 'உலகத் தமிழ் மாநாடு' : 'World Tamil Conference'}</span>
...
function Stat({ text }: { text: string }) {
  return (
    <div className="flex flex-col items-center justify-center p-4">
      <span className="font-display font-medium text-white text-lg">{text}</span>
    </div>
  );
}
